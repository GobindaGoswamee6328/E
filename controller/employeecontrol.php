...
if(isset($_REQUEST["ADD"]))
{
  ...
  if($haserror!=1)
  {
     ...
     $result2=$mydbadd->AddEmployee1($conobj2,"addemployee",$_REQUEST["name"],$_REQUEST["nid"],$_REQUEST["nationality"],
     $_REQUEST["email"], $_REQUEST["pass"],$_REQUEST["birth"],$_REQUEST["nmbr"], $_REQUEST["gender"],$_REQUEST["address"]);
